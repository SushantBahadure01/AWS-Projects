...
Our project allows you to create a serverless web application that calculates the area of a rectangle based on user-provided length and width values. This README serves as a quick guide.
...
1. **Prerequisites**
   ...
   - Access the project files from [Amplify Web-app](https://github.com/SushantBahadure01/AWS-Projects/tree/master/Amplify).
